...
public class MyBaiduLocationClient {
    ...
    public static MyBaiduLocationClient getInstance(Context mContext) {
        if (mBDLClient == null) {
            mBDLClient = new MyBaiduLocationClient();
            mBDLClient.mLocationClient = new LocationClient(mContext
    ...
    public void startLoc(final MyBDLocationListener mBdll) {
        if (mBdll != null){
            mLocationClient.registerLocationListener(new BDLocationListener() {
                ...
                public void onReceiveLocation(BDLocation bdLocation) {
                    ...
                    mBdll.onReceiveLocation(bdLocation);
                }
            });
            if (!mLocationClient.isStarted()){
