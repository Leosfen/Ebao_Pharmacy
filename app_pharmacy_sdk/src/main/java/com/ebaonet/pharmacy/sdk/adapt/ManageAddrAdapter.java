...
public class ManageAddrAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (list.size() > 0) {
            ...
            final String addrinfo = mAddress.getProvName() + mAddress.getCityName() + mAddress.getBiotopeName() + mAddress.getAddr();
            holder.tvAddr.setText(Utils.replaceDefaultString(addrinfo));
