...
public class ShoppingCarAdapter extends BaseExpandableListAdapter {
    ...
    private HashMap<Integer, Boolean> groupstatus = new HashMap<Integer, Boolean>();//全选按钮状态
    private ArrayList<HashMap<Integer, Boolean>> status = new ArrayList<HashMap<Integer, Boolean>>();//单个item选中状态
    private ShoppingCarChangeListener mlistener;
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        holder.plus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mlistener.NormalItemChange(groupPosition, childPosition, "add", status);
            }
        });
        holder.minus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mlistener.NormalItemChange(groupPosition, childPosition, "minus", status);
            }
        });
    ...
    private void setSelectAll(int groupPosition) {
        ...
        mlistener.NormalSelectChange(status);
